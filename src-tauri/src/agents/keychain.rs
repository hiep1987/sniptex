...
pub fn has_cloud_goclaw_api_key() -> bool {
    has(CLOUD_GOCLAW_ACCOUNT)
}

pub fn get_cloud_goclaw_api_key() -> Result<String, KeychainError> {
    get(CLOUD_GOCLAW_ACCOUNT)
}

pub fn set_cloud_goclaw_api_key(key: &str) -> Result<(), KeychainError> {
    set(CLOUD_GOCLAW_ACCOUNT, key)
}
